...
- Keeps `src/Controller/AccessingOperatorSurfaceBuilder.php` as the operator surface route owner.
...
- `src/Controller/AccessingOperatorController.php` because `src/Controller/AccessingOperatorSurfaceBuilder.php` owns the operator surface routes.
