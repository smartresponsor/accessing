...
final class AccessOperatorRoutesTest extends WebTestCase
{
    /**
    ...
    {
        static::getContainer()->set(AccessAccountRepositoryInterface::class, new class($targetAccount) implements AccessAccountRepositoryInterface {
        ...
        static::getContainer()->set(AccessSecurityEventRepositoryInterface::class, new class implements AccessSecurityEventRepositoryInterface {
