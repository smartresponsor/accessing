...
final class AccessVerificationRoutesTest extends WebTestCase
{
    ...
    {
        static::getContainer()->set(AccessVerificationChallengeServiceInterface::class, new class implements AccessVerificationChallengeServiceInterface {
            public function issueEmailVerification(AccessAccountEntity $account, ?\Symfony\Component\HttpFoundation\Request $request = null): AccessIssuedChallengeDto
            {
                throw new \LogicException('Not used in this smoke test.');
            }

            public function issuePhoneVerification(AccessAccountEntity $account, string $phoneNumber, ?\Symfony\Component\HttpFoundation\Request $request = null): AccessIssuedChallengeDto
            {
                throw new \LogicException('Not used in this smoke test.');
            }

            public function issuePasswordRecovery(AccessAccountEntity $account, ?\Symfony\Component\HttpFoundation\Request $request = null): AccessIssuedChallengeDto
            {
                throw new \LogicException('Not used in this smoke test.');
            }
