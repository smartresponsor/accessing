 ...
 */
final readonly class AccessingAccountAdministrationHealthReport
{
    /**
     * @param list<AccessingAccountAdministrationHealthDescriptor> $checks
    ...
    /** @return list<AccessingAccountAdministrationHealthDescriptor> */
        ...
        return [
            ...
            'summary' => [
                ...
                'blockingChecks' => count(array_filter(
                    $this->checks,
                    static fn (AccessingAccountAdministrationHealthDescriptor $check): bool => $check->blocking(),
                )),
                'byStatus' => $this->countByStatus(),
                'bySeverity' => $this->countBySeverity(),
            ],
            'checks' => array_map(
                static fn (AccessingAccountAdministrationHealthDescriptor $check): array => $check->toSafeArray(),
                $this->checks,
            ),
            'guards' => $this->guards,
        ];
