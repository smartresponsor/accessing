...
/**
 * Safe result for controlled Accessing user administration actions.
 */
final readonly class AccessUserAdministrationResult
{
    ...
    /** @param array<string, mixed> $safeContext */
    public static function success(string $safeMessage = 'User administration action accepted.', array $safeContext = []): self
    {
