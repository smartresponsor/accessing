 ...
 */
final readonly class AccessingAccountAdministrationRequest
{
    ...
    public function toAction(): AccessingAccountAdministrationAction
    {
        return new AccessingAccountAdministrationAction(
            $this->action,
