...
/**
 * Defines the passkey registration options dto type and its canonical responsibility within the Accessing component.
 */
final readonly class AccessPasskeyRegistrationOptionsDTO
{
    /**
