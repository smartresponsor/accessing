...
/**
 * Defines the passkey assertion result dto type and its canonical responsibility within the Accessing component.
 */
final readonly class AccessPasskeyAssertionResultDTO
{
    /**
