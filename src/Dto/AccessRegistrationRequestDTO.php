...
/**
 * Defines the registration request dto type and its canonical responsibility within the Accessing component.
 */
final class AccessRegistrationRequestDTO
{
    #[Assert\NotBlank]
    #[Assert\Email]
    public string $email = '';
    ...
    #[Assert\Callback]
    /**
     * Executes the validate password differs from email operation within the canonical Accessing component workflow.
     */
