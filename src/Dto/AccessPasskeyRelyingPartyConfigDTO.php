...
/**
 * Defines the passkey relying party config dto type and its canonical responsibility within the Accessing component.
 */
final readonly class AccessPasskeyRelyingPartyConfigDTO
{
    /**
