 ...
 */
final readonly class AccessAccountAdministrationExecutionPlanProvider implements AccessAccountAdministrationExecutionPlanProviderInterface
{
    public function __construct(
        private AccessAccountAdministrationWorkPlanProviderInterface $workPlanProvider,
    ...
    public function plan(): AccessAccountAdministrationExecutionPlan
    {
        ...
        return new AccessAccountAdministrationExecutionPlan(
