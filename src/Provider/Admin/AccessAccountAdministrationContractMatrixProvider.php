...
use App\Accessing\Value\Admin\AccessAccountAdministrationContractDescriptor;
 ...
 */
final readonly class AccessAccountAdministrationContractMatrixProvider implements AccessAccountAdministrationContractMatrixProviderInterface
{
    ...
    public function matrix(): AccessAccountAdministrationContractMatrix
    {
        ...
        return new AccessAccountAdministrationContractMatrix(
    ...
    private function contract(
        ...
        string $runtimeMode,
        array $context = [],
    ): AccessAccountAdministrationContractDescriptor {
        return new AccessAccountAdministrationContractDescriptor(
            $key,
            $label,
            $category,
            $status,
