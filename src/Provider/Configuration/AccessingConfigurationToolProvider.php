...
use App\Accessing\Contract\AccessingIntegrationContract;
use App\Accessing\Service\Config\AccessingEnvironmentConfigService;
 ...
 */
final class AccessingConfigurationToolProvider implements ConfigurationToolProviderInterface
{
    // ------------------------------------------------------------------
    ...
    public function tools(): iterable
    {
        ...
        yield new ConfigurationToolDefinition(
            ...
            serviceClass: AccessingEnvironmentConfigService::class,
            serviceShortName: 'AccessingEnvironmentConfigService',
     ...
     */
    public function integrationContract(): AccessingIntegrationContract
    {
        return AccessingIntegrationContract::fromYaml(
