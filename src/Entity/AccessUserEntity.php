...
#[ORM\UniqueConstraint(name: 'uniq_access_user_email', columns: ['email'])]
class AccessUserEntity implements UserInterface, PasswordAuthenticatedUserInterface, TwoFactorInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    /** @var Collection<int, AccessUserSessionEntity> */
    #[ORM\OneToMany(targetEntity: AccessUserSessionEntity::class, mappedBy: 'user', cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    /** @return Collection<int, AccessUserSessionEntity> */
    public function getUserSessions(): Collection
    {
        return $this->userSessions;
    }

    public function addUserSession(AccessUserSessionEntity $userSession): self
    {
