...
class AccessAccountSessionEntity
{
    ...
    #[ORM\ManyToOne(targetEntity: AccessAccountEntity::class, inversedBy: 'accountSessions')]
     ...
     */
    public function __construct(?AccessAccountEntity $account = null, ?string $sessionIdentifier = null, ?string $ipAddress = null, ?string $userAgent = null)
    {
