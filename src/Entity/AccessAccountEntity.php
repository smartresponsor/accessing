...
class AccessAccountEntity implements UserInterface, PasswordAuthenticatedUserInterface, TwoFactorInterface
{
    ...
    #[ORM\OneToOne(targetEntity: AccessSecondFactorEntity::class, mappedBy: 'account', cascade: ['persist', 'remove'])]
    private ?AccessSecondFactorEntity $secondFactor = null;

    /** @var Collection<int, AccessRecoveryCodeEntity> */
    #[ORM\OneToMany(targetEntity: AccessRecoveryCodeEntity::class, mappedBy: 'account', cascade: ['persist', 'remove'], orphanRemoval: true)]
    private Collection $recoveryCodes;

    /** @var Collection<int, AccessVerificationChallengeEntity> */
    #[ORM\OneToMany(targetEntity: AccessVerificationChallengeEntity::class, mappedBy: 'account', cascade: ['persist', 'remove'], orphanRemoval: true)]
    private Collection $verificationChallenges;

    /** @var Collection<int, AccessAccountSessionEntity> */
    #[ORM\OneToMany(targetEntity: AccessAccountSessionEntity::class, mappedBy: 'account', cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    /** @return Collection<int, AccessAccountSessionEntity> */
    public function getAccountSessions(): Collection
    {
        return $this->accountSessions;
    }

    public function addAccountSession(AccessAccountSessionEntity $accountSession): self
    {
