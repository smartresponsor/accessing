...
#[ORM\Entity]
#[ORM\Table(name: 'access_user_session')]
#[ORM\Index(name: 'idx_access_user_session_expires_at', columns: ['expires_at'])]
#[ORM\Index(name: 'idx_access_user_session_revoked_at', columns: ['revoked_at'])]
class AccessUserSessionEntity
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(targetEntity: AccessUserEntity::class, inversedBy: 'userSessions')]
     ...
     */
    public function __construct(?AccessUserEntity $user = null, ?string $sessionIdentifier = null, ?string $ipAddress = null, ?string $userAgent = null)
    {
