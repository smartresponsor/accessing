...
final readonly class AccessUserAuthenticationService implements AccessUserAuthenticationServiceInterface
{
    ...
    public function __construct(
        ...
        private AccessUserSessionServiceInterface $userSessionService,
    ...
    private function signIn(AccessUserEntity $user, Request $request): void
    {
        $session = $request->getSession();
