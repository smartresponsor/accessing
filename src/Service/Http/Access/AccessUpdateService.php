...
final readonly class AccessUpdateService
{
    ...
    {
        throw AccessCrudSkeletonException::unsupported('access.update_id', (string) $id);
    }

    public function updateBySlug(string $slug): Response
    {
        throw AccessCrudSkeletonException::unsupported('access.update_slug', $slug);
    }
}
