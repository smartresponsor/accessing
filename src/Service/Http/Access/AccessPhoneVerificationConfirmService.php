...
/**
 * Defines the phone verification confirm service type and its canonical responsibility within the Accessing component.
 */
final readonly class AccessPhoneVerificationConfirmService
{
    /**
